      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col">
          ...
          <div
            ...
            className="relative flex-1 min-h-[240px] mt-1 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 hover:border-indigo-400 hover:bg-indigo-50/20 transition-all cursor-pointer group"
          >
            {preview ? (
              <>
